...
>
  <Slideshow
    class="flex h-[65vh] max-h-175 min-h-140 justify-evenly rounded-sm contain-paint"
    bind:idx
    {meta}
  />
...
<div class="relative flex-1">
  <h1
    class="xs:text-2xl font-serif text-xl font-bold text-balance lg:text-3xl xl:text-4xl 2xl:text-5xl"
  >
    {title}
  </h1>

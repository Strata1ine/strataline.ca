...
description: "Our process includes dust-free popcorn removal, skim coating, sanding and the application of primer and paint for the flattest finish."
covers:
  - src: ./cover.jpg
    alt: tomatoes
header:
...
<Section.Question
  ...
  id="why"
  description={`
Popcorn ceilings, were popular for their ability to hide imperfections. However, due to their dated appearance and difficulty cleaning they are removed.
  `}
>
